package com.mytrip.util.pageobject;
...
public class PageObject {
	...
	public String toString() {
		return "PageObject [page=" + page + ", perPageNum=" + perPageNum + ", startRow=" + startRow + ", endRow="
				...
				+ ", totalPage=" + totalPage + ", totalRow=" + totalRow + ", key=" + key + ", word=" + word + ", kind="
				+ kind + ", area=" + area + ", period=" + period + ", accepter=" + accepter + ", acceptMode="
				+ acceptMode + "]";
	}
